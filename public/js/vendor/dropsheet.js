...
var DropSheet = function DropSheet(opts) {
	...
	function readFile(e, files) {
		...
		opts.drop.style.backgroundColor = '#ffffff'; // added.
	}
	...
	function handleDragover(e) {
		...
		opts.drop.style.backgroundColor = '#ffeeee'; // added.
	}
	...
	if(opts.drop.addEventListener) {
		...
		if (opts.filefieldid) opts.filefieldid.addEventListener('change', handleChange, false); // added.
	}
